...
'''
:author: Pratik K
:brief: This script demonstrates how to implement a basic character-level
...
def main():
    ...
    train = store['train']  # this is a parallel dataset of ['en', 'hi']
    print(f"Loaded dataset! Training size {train.shape}")

    # loading the data
    for idx, line in train.T.iteritems():
        input_text, target_text = line['en'], line['hi']
